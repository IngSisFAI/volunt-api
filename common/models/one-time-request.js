...
module.exports = function(Onetimerequest) {
  ...
  Onetimerequest.beforeRemote('create', function(ctx, res, next) {
    var error = new Error();
  ...
  Onetimerequest.beforeRemote('prototype.patchAttributes',
    function(ctx, res, next) {
      var error = new Error();
     // console.log(ctx.req.body);
      Onetimerequest.findById(ctx.req.body.id, function(err, onetime) {
        if (err) {
  ...
  Onetimerequest.beforeRemote('deleteById',
    function(ctx, res, next) {
      var error = new Error();
      console.log(ctx.req.body.id);
      // me fijo que el id del onetimerequest exista
      Onetimerequest.findById(ctx.req.body.id, function(err, onetime) {
        if (err) {
