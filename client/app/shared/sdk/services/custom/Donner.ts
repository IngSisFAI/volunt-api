...
export class DonnerApi extends BaseLoopBackApi {
   ...
   *
   *  - `urlArg` – `{string}` - Sample multiline
         *    argument description
   *
   *  - `bodyArg` – `{string}` - Sample multiline
         *    argument description
   *
   ...
   *  - `sampleReturn` – `{string}` - 
   */
  public sampleRemoteMethod(urlArg: any, bodyArg: any, customHeaders?: Function): Observable<any> {
    ...
    let _urlParams: any = {};
    if (typeof urlArg !== 'undefined' && urlArg !== null) _urlParams.urlArg = urlArg;
